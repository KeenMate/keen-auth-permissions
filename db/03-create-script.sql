...
select *
from start_version_update('1', 'Initial version', _component := 'keen-auth-permissions');
...
create
    or replace function load_initial_data()
    returns setof int
    language plpgsql
as
$$
...
grant usage on schema
    const, unsecure, error, ext, auth, helpers to keen_auth_sample;
