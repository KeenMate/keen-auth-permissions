...
begin
    ...
    if __is_assignable is null or not __is_assignable or __is_external then
...
create function public.delete_user_group(_deleted_by text, _user_id bigint, _tenant_id int, _user_group_id int)
    returns table
            (
                __group_id int
            )
