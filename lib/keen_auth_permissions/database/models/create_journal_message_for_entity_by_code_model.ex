...
defmodule KeenAuthPermissions.Database.Models.CreateJournalMessageForEntityByCodeModel do
  @moduledoc """
  Model for public.create_journal_message_for_entity_by_code stored procedure result.
  """
